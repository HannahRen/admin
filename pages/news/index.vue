...
<div class="page-list">
  <div class="list-header">
    <div class="list-tools-button">
      <div class="tools-left">
        <el-button-group>
          <el-button :plain="true" icon="plus" @click="onAdd('add')">新增</el-button>
        </el-button-group>
      </div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-search-form" label-width="100px">
      ...
      <el-form-item label="备注">
        <el-input v-model="formSearch.comment" placeholder="备注"></el-input>
      </el-form-item>
  ...
  <el-table :data="gridData" border style="width: 100%" height="100%" class="list-table-grid" @sort-change="sortChange">
    ...
    <!-- <el-table-column prop="content" label="正文" width="120"> </el-table-column> -->
    ...
    <el-table-column prop="top" label="是否置顶" width="120" :formatter='formatTop'> </el-table-column>
    <el-table-column fixed="right" label="操作" width="180"><template scope="scope">
        <el-button type="text" size="small" @click.native.prevent="onDetail(scope.$index, gridData)">查看</el-button>
        <el-button type="text" size="small" @click.native.prevent="onEdit(scope.$index, gridData)">编辑</el-button>
        <el-button type="text" size="small" @click.native.prevent="onDelete(scope.$index, gridData)">删除</el-button>
</template>
    </el-table-column>
  </el-table>
